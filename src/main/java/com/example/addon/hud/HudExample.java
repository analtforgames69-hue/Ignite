...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(AddonTemplate.HUD_GROUP, "Rotated Deepslate ESP", "Highlights rotated deepslate.", HudExample::new);
